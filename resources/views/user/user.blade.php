                ...
                <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            @if(Auth::user()->is_admin==2)
                                 <td>
                                    ...
                                    <td>
                                    <button data-bs-toggle="modal" data-bs-target="#deleteuser{{$info->id}}"  class="btn btn-danger">Delete</button>
                                </td>
                            @else
                                <td></td>
                            @endif
                    ...
                    <div class="modal right fade" id="edituser{{ $info->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                     ...
                     <!-- Modal for delete user -->
                        <div class="modal right fade deleteModel" id="deleteuser{{ $info->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <!-- this is edit form-->
                                    <form action="/deleteuserInfo/{{$info->id}}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <div class="modal-footer">
                                            <p class="p-3"style="font-weight:bold;">Are you want to delete {{$info->name}} from your user table</p>
                                        </div>
